...
workflow biomodalDuet {
    ...
    parameter_meta {
        ...
        slurmPartition:         "Partition Nextflow submits its own jobs to, required when scheduler resolves to slurm. The pipeline's slurm profile names a queue that exists only at the vendor's own site"
